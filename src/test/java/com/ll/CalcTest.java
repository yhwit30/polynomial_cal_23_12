...
public class CalcTest {
  ...
  @Test
  @DisplayName("10 * 15 + 10 == 160")
  void t27() {
    assertThat(Calc.run("10 * 15 + 10")).isEqualTo(160);
  }

  @Test
  @DisplayName("10 * 15 + 10 * 20 == 350")
  void t28() {
    assertThat(Calc.run("10 * 15 + 10 * 20")).isEqualTo(350);
  }
